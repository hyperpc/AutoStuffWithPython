...
for quizNum in range(35): 
    ...
    quizFile = open('.\Part_2\ch08_FileIO\8_5_randomQuizGen\Quiz\capitalsquiz%s.txt' % (quizNum + 1), 'w')
    answerKeyFile = open('.\Part_2\ch08_FileIO\8_5_randomQuizGen\Quiz\capitalsquiz_answers%s.txt' % (quizNum + 1), 'w')
